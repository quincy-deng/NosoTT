...
if(plotD):
    ...
    f.writelines('digraph G {\nnode [width=.3,height=.3,shape=circle,style=filled,color=orange];\noverlap="false";\nrankdir="LR";\n')
    f.writelines
    for i in G.keys():
        f.writelines(i+';\n')
        for j in G[i].keys():
    ...
    print("File "+args.outputF+"_direct_transmissions.jpg containing graph of direct transmission successfully created!\n")
...
if(plotI):
    ...
    print("File "+args.outputF+"_indirect_transmissions.jpg containing graph of indirect transmission successfully created!\n")
